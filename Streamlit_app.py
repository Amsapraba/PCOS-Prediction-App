...
def preprocess_data(df):
    # Select relevant features (consider adding more than just beta-HCG & AMH)
...
fig, ax = plt.subplots(figsize=(8, 6))
sns.barplot(x=importance, y=X.columns, legend=False, palette="Blues_d")
...
shap_fig = shap.plots.bar(explainer(X_train))
st.pyplot(shap_fig)
